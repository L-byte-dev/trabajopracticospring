...
import com.informatorio.trabajopracticospring.dto.error.ErrorRespuestaDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<ObjectError> validacionesErrorList = ex.getBindingResult().getAllErrors();

        for (ObjectError error : validacionesErrorList) {
